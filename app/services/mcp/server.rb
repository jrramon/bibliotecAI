module Mcp
  ...
  class Server
    ...
    def self.call(user:, payload:, message_id: nil, trace_id: nil)
      new(user, message_id: message_id, trace_id: trace_id).handle(payload)
    end

    def initialize(user, message_id: nil, trace_id: nil)
      @user = user
